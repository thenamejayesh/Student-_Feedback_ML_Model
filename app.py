...
# ----------------------------------------------------
# Label Encoding Mapping (IMPORTANT)
# ----------------------------------------------------
label_encoder_department = {
    "IT": 0,
    "HR": 1,
    "Finance": 2,
    "Sales": 3,
...
DEPT_OPTIONS = list(label_encoder_department.keys())
...
# Encode department
department_encoded = label_encoder_department[department]
